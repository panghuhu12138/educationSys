		...
		<el-container>
			...
			<el-container>
				...
				<el-header style="height:38px;padding:0;margin-bottom:7px;">
					...
					<div class="sys-title">南京市新型经营主体信息（信用）管理系统</div>
					<div class="logout">
						<el-dropdown class="user-head-drop">
							<!--头像、用户下拉-->
							<el-button type="text" size="small"><i class="el-icon-user"></i>经管站 李晓明<i
									class="el-icon-caret-bottom"></i></el-button>
							<el-badge :value="4" type="danger">
								<el-button type="text" size="small" @click="drawerdb = true"><i
										class="el-icon-document-remove"></i>待办事项</el-button>
							</el-badge>
							<el-dropdown-menu slot="dropdown">
								<!-- 下拉菜单内click事件必须是@click.native -->
								<el-dropdown-item @click.native="dialogpassword = true"><span>修改密码</span>
								</el-dropdown-item>
								<el-dropdown-item @click.native="dialogweixin = true">绑定微信</el-dropdown-item>
							</el-dropdown-menu>
						</el-dropdown>
						<el-dropdown class="mess-drop">
							<el-badge :value="3" type="danger">
								<el-button type="text" size="small" style="margin-top:-1px;"><i
										class="el-icon-message"></i>消息<i class="el-icon-caret-bottom"></i>
								</el-button>
							</el-badge>
							<el-dropdown-menu slot="dropdown">
								<!-- 下拉菜单内click事件必须是@click.native -->
								<el-dropdown-item v-for="(item,index) in items" :key="index" style="font-size:12px;">
									<!-- 主体信息代报 有 <span style="color:red;">5</span> 条信息代办 -->
									{{item.news}}
									<el-button size="mini" type="primary" size="default" @click="closeDropdown(index)"
										style="margin-left:5px;">已知晓</el-button>
								</el-dropdown-item>
								<!-- <el-dropdown-item @click.native="ChildAddTabs('信息申报审核','信息申报审核','','信息申报审核.html')">
										信息申报审核 有 <span style="color:red;">15</span> 条信息代办
									</el-dropdown-item> -->
							</el-dropdown-menu>
						</el-dropdown>
						<el-button type="text" size="small"><i class="el-icon-switch-button"></i>退出</el-button>
					</div>
				</el-header>
				<!--主显示区域-->
				<el-main>
